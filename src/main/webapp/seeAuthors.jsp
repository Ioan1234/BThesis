                                    ...
                                    <%
                                        ...
                                        if (session.getAttribute("accountType") != null) {
                                            ...
                                            if(session.getAttribute("accountType").equals("author")) {
                                                ...
                                                displayName = "<strong>" + findUserRESULT.getString("surname") + " " + findUserRESULT.getString("name") + " - " + session.getAttribute("accountType") + "</strong>";
    ...
    <div class="row">  <!-- Add a row here -->
        ...
        <div class="col-lg-4">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title"><%= rs.getString("name") + " " + rs.getString("surname") %></h5>
                    <a href="authorProfile.jsp?author_id=<%= rs.getInt("author_id") %>" class="btn btn-primary">View Profile</a>
                </div>
            </div>
        </div>
        <% } %>
