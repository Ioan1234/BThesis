...
<div class="container" style="padding: 20px">
    <p class="h3 my-5 text-center">Similar news to the one you have just read</p>
    <div class="row">
        <% List<News> similarNews = (List<News>) request.getAttribute("similarNews");
            for(News news : similarNews) { %>
        <div class="col-md-4 mb-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        <a href="seeOtherNews.jsp?news_id=<%= news.getNewsId() %>"><%= news.getNewsTitle() %></a>
                    </h5>
                </div>
            </div>
        </div>
