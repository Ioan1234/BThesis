...
<%@ page import="java.sql.SQLException" %><%
    ...
    try {
        ...
        // Archive category
        String sqlCategory = "UPDATE categories SET category_availability=0 WHERE category_name=?";
        ...
        String sqlNews = "UPDATE news INNER JOIN categories ON news.category_id = categories.category_id SET news.news_availability=0 WHERE categories.category_name=?";
